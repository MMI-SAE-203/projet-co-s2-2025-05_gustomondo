...
const $$Header = createComponent(($$result, $$props, $$slots) => {
  ...
  <\/script> </header>`])), maybeRenderHead(), renderComponent($$result, "AuthButtons", $$AuthButtons, {}), renderComponent($$result, "AuthButtons", $$AuthButtons, { "mobile": true, "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/enzor/Documents/GitHub/projet-co-s2-2025-05_gustomondo/src/components/AuthButtons.astro", "client:component-export": "default" }));
